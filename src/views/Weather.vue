<template>
  <div id = "app2" :class= "typeof weather.main != 'undefined' &&  weather.main.temp - 273 > 16 ? 
    'warm': '' ">
    ...
    <main>
      ...
      <div class="weather-wrap" v-if="typeof weather.main !='undefined'">
        ...
        <div class="weather-box">
          <div class="temp">{{ Math.round(weather.main.temp - 273) }}°С</div>
          <div class="weather">
...
export default {
  ...
  data () {
    return {
      api_key:'5a4d2158666e70ee88bd299dcc12ab40',
